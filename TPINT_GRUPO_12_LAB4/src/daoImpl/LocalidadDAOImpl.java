...
public class LocalidadDAOImpl implements LocalidadDAO {
	...
	public ArrayList<Localidad> listar() {
		...
		Connection cn = Conexion.getConexion().getSQLConexion();
		try {
			statement = cn.prepareStatement("Select * From Localidades l inner join Provincia p on p.codProvincia=l.codProvincia inner join pais pa on pa.codPais=p.codPais");
