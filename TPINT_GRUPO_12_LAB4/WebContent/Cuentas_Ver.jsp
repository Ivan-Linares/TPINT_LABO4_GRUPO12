	...
	<div class="container ">
		<div class="row">
			<div class="col-8">
				...
				%>
				<h3>Filtrar por:</h3>
				<input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1"> DNI Cliente
				<br>
				<input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked> NRO Cuenta
				<br>
				<br>
				<input class="form-control" type="text" placeholder="Ingrese el parametro..." 	aria-label="default input example"> 
				<br>
				...
				%>
				<input class="form-control" type="text" placeholder="42899522" aria-label="default input example" disabled> <br>
				<%
					}
				%>
				<br>
